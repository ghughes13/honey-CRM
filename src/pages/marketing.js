          ...
          <Container className="pink-blob container-1">
            <Row>
              <Col className="mobile-only">
                <img src={require("../images/marketing/Group 7118.png")} />
              </Col>
            ...
            <Row>
              <Col className="max-width-900 margin-auto">
                ...
                <h5>
                  ...
                  revenue. You’ve probably heard more than one variation of
                  “this lead isn’t an SQL.”
                </h5>
                <h5>That’s a thing of the past with Honey.</h5>
                <h5>
                  With Honey, you get to see the complete picture of your
                  marketing efforts. And when you hand that lead off to your
                  sales team, you know its qualified.
                </h5>
              </Col>
            </Row>
          </Container>
          ...
          <Container className="container-4">
            <Row>
              ...
              <Col className="one-half second-col max-width-500 ">
                ...
                <p>
                  Schedule the exact date, time and topic of every email you
                  want to send out ahead of time. Any content you need already
                  exists in the Honey collateral library, and all calls to
                  action are automatically linked to the collateral piece of
                  your choosing.
                </p>
            ...
            <Row className="flexed-mobile">
              <Col className="one-half max-width-500 margin-left-10-perc">
                ...
                <p>
                  ...
                  subject lines or content on a portion of your list and send
                  out the best performer to your full list automatically
                </p>
              </Col>
          ...
          <Container className="container-6">
            <Row>
              <Col className="one-half centered-text">
                <img src={require("../images/marketing/Group 7119.png")} />
              </Col>
          ...
          <Container className="container-9">
            <Row className="flexed-mobile">
              <Col className="one-half max-width-500 margin-left-10-perc">
                ...
                <p>
                  And if you use vendor marketing materials, your vendor
                  partners can share their collateral library with you so you
                  have one place to go to for all of your marketing assets.
                </p>
              </Col>
              <Col className="one-half centered-text second-col">
                <img src={require("../images/marketing/Group 7121.png")} />
              </Col>
            </Row>
          </Container>
