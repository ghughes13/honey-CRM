        ...
        <div className="agencies-page">
          ...
          <Container className="grey-swish-background container-2 ">
            <Row className="">
              <Col className=" max-width-900 centered-text">
                ...
                <p>
                  Digital marketing can change at the drop of a hat, and the
                  only way to stay on top of market shifts is with great
                  analytics and expert partner management.
                </p>
                <p>
          ...
          <Container className="container-5 ">
            <Row className="">
              ...
              <Col className="one-half max-width-480">
                ...
                <p>
                  Visibility is a central pillar of Honey. The core functions,
                  as well as the look and feel, were created to enable intuitive
          ...
          <Container className="container-6 ">
            <Row className="flexed-mobile">
              <Col className="centered-text max-width-700">
                ...
                <p>
                  Many industries have been reaping the benefits of automation
                  for some time now. We figured it was time sales and marketing
                  could do the same.
                </p>
                <p>
          ...
          <Container className="container-8 ">
            <Row className="flexed-mobile">
              <Col className="centered-text max-width-700">
                <h3 className="purple-text">
                  Package And Resell Your Marketing
                </h3>
                <p>
                  Created emails, collateral, journeys, or entire marketing
                  plans that you want to sell to future clients?
                </p>
                <p>
                  Honey allows you to package up any of your past marketing so
                  it can be reused for future clients. It even automatically
                  rebrands with the right colors, logos and links.
                </p>
              </Col>
            </Row>
            ...
            <Row className="flexed-mobile">
              <Col className="centered-text ">
                ...
                <p className="max-width-650 margin-auto">
                  Want to see who your top-performing client is? It’s right
                  there. What about your average open and click-through rates?
                  That’s there too.
                </p>
                <p className="max-width-650 margin-auto">
                  There is even an overview of total leads, meetings,
                  opportunities and wins to keep your team aware of the
                  importance and success of the work they do.
                </p>
              </Col>
            </Row>
              ...
              <div className="logos-container deep-purple-background centered-text">
                ...
                <div className="logo-images">
                  ...
                  <div className="one-third first">
                    <img src={require("../images/agencies/Group 7071.png")} />
                  </div>
                  ...
                  <div className="one-third sixth">
                    <img src={require("../images/agencies/spclogo.png")} />
                  </div>
                  <div className="one-third fifth">
                    <img src={require("../images/agencies/Group 7069.png")} />
                  </div>
                  <div className="one-third fourth">
                    <img src={require("../images/agencies/Group 7070.png")} />
                  </div>
                </div>
              </div>
            </Row>
